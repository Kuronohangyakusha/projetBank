...
class StoreClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numeroCompte' => 'required|string|unique:clients,numeroCompte|regex:/^CB\d{8}$/',
            ...
            'metadata.dateCreation' => 'nullable|date',
            'metadata.agence' => 'nullable|string|max:255',
            'metadata.telephone' => 'nullable|string|max:20',
            'metadata.profession' => 'nullable|string|max:255',
        ];
    }
    ...
    {
        return [
            'numeroCompte.regex' => 'Le numéro de compte doit commencer par CB suivi de 8 chiffres.',
